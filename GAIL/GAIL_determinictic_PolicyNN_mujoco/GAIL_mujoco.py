...
class GAIL(object):
	def __init__(self, args, state_dim, action_dim, max_action, lr, beta_init):
		...
		self.expert_buffer = data.ExpertBuffer(args.expert_traj_file, args.num_traj, args.subsamp_freq)
	...
	def update(self, n_itr, expert_buffer, batch_size=100):
		# update GAIL
		for itr in range(n_itr):
			...
			################################################
			""" COMPLETE THIS PART """
			expert_state, _, expert_action, _, _ = self.expert_buffer.sample(batch_size)
